...
#else
static uint8_t aucDefaultFWVersion[] = "Unknown";*//*changed to use g_wifiVer
#endif*/
...
char g_wifiVer[MANIFEST_BUFFER_SIZE] = {0};
int g_wifiVer_length=0;
...
struct FS_SW_ILD_T sw_feature_set_table[] = {
	...
	{FS_SW_OPTI_ID, FS_SW_OPTI_LEN,
		{FS_SW_OPTI_SUPPORT|FS_SW_OPTI_B1|FS_SW_OPTI_B2} },
